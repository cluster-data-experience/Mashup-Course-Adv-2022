  ...
  useEffect(() => {
    if(qlikData){
        function extractData() {
            let dataPages = qlikData.hypercube.qDataPages;
            ...
            if (dataPages){
                ...
                dataPages[0].qMatrix.forEach((item) => {
                    for (let i = 0; i < qlikData.hypercube.qHyperCube.qDimensionInfo.length; i++) {
                ...
                dataPages[0].qMatrix.forEach((item, index) => {
                    for (let i = 0; i < dimensionInfo.length + measureInfo.length; i++) {
